...
private class JSONPersonEmittingNull
  include AutoJson
  field name, String
  field age, Int32?, emit_null: true
end
...
private class JSONWithTime
  include AutoJson
  field value, Time, converter: Time::Format.new("%F %T")
end

private class JSONWithNilableTime
  include AutoJson
  field value, Time?, converter: Time::Format.new("%F")
end

private class JSONWithNilableTimeEmittingNull
  include AutoJson
  field value, Time?, converter: Time::Format.new("%F"), emit_null: true
end
...
private class JsonWithDefaults
  ...
  field b, String, default: "Haha"
  field c, Bool, default: true
  field d, Bool, default: false
  field e, Bool?, default: false
  field f, Int32?, default: 1
  field g, Int32?, default: nil
  field h, Array(Int32), default: [1, 2, 3]
end
...
private class JSONWithTimeEpoch
  include AutoJson
  field value, Time, converter: Time::EpochConverter
end

private class JSONWithTimeEpochMillis
  include AutoJson
  field value, Time, converter: Time::EpochMillisConverter
end

private class JSONWithRaw
  include AutoJson
  field value, String, converter: String::RawConverter
end

# private class JSONWithRoot
#   include AutoJson
#   field result, Array(JSONPerson), root: "heroes"
# end
...
#   include AutoJson
#   field result, Array(JSONPerson)?, root: "heroes", emit_null: true
# end

private class JSONWithNilableUnion
  include AutoJson
  field value, Int32 | Nil
end
...
describe "JSON mapping" do
  ...
  it "does to_json" do
    ...
    person2.name.should eq "John"
    person2.age.should eq 30
  end
